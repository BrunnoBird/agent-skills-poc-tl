...
| Arquivo         | Máx Tokens | ~Palavras | Alerta Em   |
| --------------- | ---------- | --------- | ----------- |
...
🟡 **Moderado** (40-60k): Nota discreta no rodapé
🔴 **Crítico** (>60k): Aviso ativo, sugerir otimização

## Monitoramento

Exibir status de contexto no rodapé quando >40k:
...
**Meta:** <40k tokens carregados (20% da janela)
